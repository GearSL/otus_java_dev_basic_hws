...
public class RandomFake implements RandomGenerator {
    int winningMethodCall;
    int callsCount;
    public RandomFake(int winningMethodCall) {
        this.winningMethodCall = winningMethodCall;
    }

    private int countAndReturnDice(){
        this.callsCount ++;
        if(callsCount == winningMethodCall){
            return 2;
        }
        return 1;
    }
